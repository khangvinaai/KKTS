...
function loadData1() {
    dtt1 = $("#dataTable").DataTable({
        ...
        "columns": [
            { "data": "Ma_CanBo" },
            {
                "data": { "HoTen": "HoTen", "MaNhomTaiKhoan":"MaNhomTaiKhoan"}, "render": function (data, type, row, meta) {
                    if (data.MaNhomTaiKhoan == 33 || data.MaNhomTaiKhoan == 34) {
                        return `<b>${data.HoTen}</b>`
                    }
                    return `${data.HoTen}`
                }
            },
...
function loadData2() {
    ...
    dtt2 = $("#dataTable2").DataTable({
        ...
        "columns": [
            ...
            {
                "data": { "isKeKhai": "isKeKhai" ,"Ma_CanBo": "Ma_CanBo", "TrangThai": "TrangThai", "FileDinhKem":"FileDinhKem"  }, "render": (data, type, row, meta) => {
                    ...
                    if (data.TrangThai == true && data.isKeKhai == false) {
                        ...
                        return `<div class="dropleft">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" data-model-id="${data.Ma_CanBo}" onclick="Delete(this)">
                ...
                "data": { "isKeKhai": "isKeKhai", "Ma_CanBo": "Ma_CanBo", "TrangThai": "TrangThai", "FileDinhKem": "FileDinhKem" }, "render": (data, type, row, meta) => {
                    ...
                    if (data.TrangThai == true && data.isKeKhai == false) {
                        ...
                        return `<div class="dropleft">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" data-model-id="${data.Ma_CanBo}" onclick="Delete1(this)">
                                        <a class="dropdown-item">
                                            Xóa Khỏi Danh Sách
                                        </a>    
                                    </div>
