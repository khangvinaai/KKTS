...
function loadthongbao() {
            $.get("/HT_ThongBao/GetThongBao/", (data) => {
                ...
                var soluong = data.chuaxem.length

                $('#numberthongbao').text(soluong)
                ...
                var row2 = `<div class="dropdown-divider" style="margin-top: 300px;"></div>
                    <span style="padding: 14px;">
                        Thông báo đã xem
                    </span>
                   `
                        ...
                        <div class="media">
                            <div class="media-body">
                                <h3 class="dropdown-item-title" style="font-weight: 600; margin-bottom: 5px; color: #007bff">
                                    ${value.Ten_ChucVu_ChucDanh} - ${value.tennguoigui}
                                    <span class="float-right text-sm" style="color: #ffc107"><i class="fas fa-star"></i></span>
                                </h3>
                                <h3 class="dropdown-item-title" style="font-weight: 600; margin-bottom: 5px;">
                                    ${value.Ten}
                                </h3>
                                <p  style="overflow: hidden; text-overflow: ellipsis; max-width: 300px; font-weight: 600;">${value.tb.TieuDe}</p>
                                <p  style="overflow: hidden; text-overflow: ellipsis; max-width: 300px; font-size: 13px;">${value.tb.NoiDung}</p>
