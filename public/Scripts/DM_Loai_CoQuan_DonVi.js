        ...
        .done(function (data) {
            ...
            var row1 = `
                               <div class="form-group row">
                                            <label for="cnsh" class="col-sm-3 col-form-label">Tên Loại Cơ Quan</label>
                                            <div class="col-sm-9">
                                                <input type="hidden" disable="true" class="form-control" id="Ma_Loai_CQDV" name="Ma_Loai_CQDV" value="${data.Ma_Loai_CQDV}">
                                                <input type="text" class="form-control" placeholder="nhập tên chức vụ" id="Ten_Loai_CQDV" name="Ten_Loai_CQDV" value="${data.Ten_Loai_CQDV}">
                                            </div>
                                        </div>
        ...
        if (result.isConfirmed) {
            $.post(url, { id: Ma_Loai_CQDV })
                .done(function (data) {
                    ...
                    if (data != false) {
                        dt.rows(`#row_${data.Ma_Loai_CQDV}`)
                            .remove()
                            .draw();
                        Swal.fire({
                            icon: 'success',
